...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Button5.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(39), CByte(60), CByte(117))
        ...
        Button5.Location = New Point(0, 474)
        Button5.Name = "Button5"
        Button5.Size = New Size(250, 65)
        Button5.TabIndex = 7
        Button5.Text = "About Me"
        ...
        Button4.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(39), CByte(60), CByte(117))
        ...
        Button3.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(39), CByte(60), CByte(117))
        ...
        Button2.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(39), CByte(60), CByte(117))
        ...
        Button1.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(39), CByte(60), CByte(117))
        ...
        Button1.Location = New Point(0, 214)
        ...
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(250, 160)
        Panel4.TabIndex = 3
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = CType(resources.GetObject("PictureBox1.Image"), Image)
        PictureBox1.Location = New Point(60, 15)
        ...
        ' Panel2
        ' 
        Panel2.BackColor = Color.FromArgb(CByte(194), CByte(54), CByte(22))
        Panel2.Dock = DockStyle.Top
        Panel2.Location = New Point(0, 0)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(250, 54)
        Panel2.TabIndex = 1
        ' 
        ' Panel5
        ' 
        Panel5.BackColor = Color.FromArgb(CByte(39), CByte(60), CByte(117))
        Panel5.Dock = DockStyle.Top
        Panel5.Location = New Point(250, 0)
        Panel5.Name = "Panel5"
        Panel5.Size = New Size(981, 54)
        Panel5.TabIndex = 3
        ' 
        ' Panel3
        ' 
        Panel3.Dock = DockStyle.Fill
        Panel3.Location = New Point(250, 54)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(981, 688)
        Panel3.TabIndex = 4
        ' 
        ' Form1
        ' 
